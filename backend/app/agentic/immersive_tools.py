...
async def react_to_interaction(
    ...
    return ctx.api.update_disposition(npc_id=ctx.agent_id, deltas=deltas, reason=reason)
...
async def report_flash_evaluation(
    ...
    ctx.api.set_flash_result(prompt, bool(result))
...
async def heal_player(ctx: AgenticContext, amount: int) -> Dict[str, Any]:
    ...
    return ctx.api.heal(int(amount))
...
async def damage_player(ctx: AgenticContext, amount: int) -> Dict[str, Any]:
    ...
    return ctx.api.damage(int(amount))
...
async def add_xp(ctx: AgenticContext, amount: int) -> Dict[str, Any]:
    ...
    return ctx.api.add_xp(int(amount))
...
async def add_item(
    ...
    return ctx.api.add_item(item_id, item_name, int(quantity))
...
async def remove_item(
    ...
    return ctx.api.remove_item(item_id, int(quantity))
...
async def activate_event(ctx: AgenticContext, event_id: str) -> Dict[str, Any]:
    ...
    return ctx.api.activate_event(event_id)
...
async def complete_objective(ctx: AgenticContext, objective_id: str) -> Dict[str, Any]:
    ...
    return ctx.api.complete_objective(objective_id)
...
async def advance_stage(
    ...
    return ctx.api.advance_stage(event_id, stage_id)
...
async def complete_event_objective(
    ...
    return ctx.api.complete_event_objective(event_id, objective_id)
...
async def update_disposition(
    ...
    return ctx.api.update_disposition(npc_id, deltas, reason)
